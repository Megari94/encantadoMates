...
export default function Contact() {
  return (
    <section id="contacto" className="section-anchor section-pattern px-5 py-16 sm:px-8 sm:py-24">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-2">
          <Reveal className="surface-card flex flex-col items-center gap-3 rounded-[30px] bg-gradient-to-br from-[#f0cec8] to-blush/55 p-8 text-center sm:p-10">
          ...
          <Reveal delay={100} className="surface-card flex flex-col items-center gap-3 rounded-[30px] bg-gradient-to-br from-[#dce3cf] to-sage/55 p-8 text-center sm:p-10">
            <span className="flex h-14 w-14 items-center justify-center rounded-full border-2 border-ink/70 text-ink">
